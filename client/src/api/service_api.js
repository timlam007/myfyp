...
export const authServiceAPI = axios.create({
    baseURL: REACT_APP_AUTHENTICATION_SERVICE_URL || `http://18.207.207.250:${REACT_APP_AUTHENTICATION_SERVICE_PORT}`
})

export const commonServiceAPI = axios.create({
    baseURL: REACT_APP_COMMON_DATA_SERVICE_URL || `http://18.207.207.250:${REACT_APP_COMMON_DATA_SERVICE_PORT}`
})

export const searchSuggestionServiceAPI = axios.create({
    baseURL: REACT_APP_SEARCH_SUGGESTION_SERVICE_URL || `http://18.207.207.250:${REACT_APP_SEARCH_SUGGESTION_SERVICE_PORT}`
})